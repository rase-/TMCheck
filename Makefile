...
pkgdatadir = $(datadir)/check
pkglibdir = $(libdir)/check
pkgincludedir = $(includedir)/check
...
PRE_UNINSTALL = :
POST_UNINSTALL = :
build_triplet = i386-apple-darwin12.2.1
host_triplet = i386-apple-darwin12.2.1
subdir = .
...
ACLOCAL = ${SHELL} /Users/rase/Downloads/check-0.9.8/build-aux/missing --run aclocal-1.10
AMTAR = ${SHELL} /Users/rase/Downloads/check-0.9.8/build-aux/missing --run tar
AR = ar
AUTOCONF = ${SHELL} /Users/rase/Downloads/check-0.9.8/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /Users/rase/Downloads/check-0.9.8/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /Users/rase/Downloads/check-0.9.8/build-aux/missing --run automake-1.10
AWK = awk
CC = gcc
CCDEPMODE = depmode=gcc3
CFLAGS = -g -O2 -Wall -ansi -pedantic -Wextra -Wstrict-prototypes -Wmissing-prototypes -Wwrite-strings -Wno-variadic-macros
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /Users/rase/Downloads/check-0.9.8/build-aux/missing --run makeinfo
...
TEX = false
VERSION = 0.9.8
abs_builddir = /Users/rase/Downloads/check-0.9.8
abs_srcdir = /Users/rase/Downloads/check-0.9.8
abs_top_builddir = /Users/rase/Downloads/check-0.9.8
abs_top_srcdir = /Users/rase/Downloads/check-0.9.8
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
acx_pthread_config = 
am__include = include
...
install_sh = $(SHELL) /Users/rase/Downloads/check-0.9.8/build-aux/install-sh
...
pdfdir = ${docdir}
prefix = /usr/local/Cellar/check/0.9.8
...
SVNChangeLog:
	if [ -e .svn ] ; then \
	svn log -v /Users/rase/Downloads/check-0.9.8 > $@ ;\
	else \
